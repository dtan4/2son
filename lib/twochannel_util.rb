...
module TwoChannelParser
  ...
  def get_dat_url(thread_url)
    if thread_url != nil && validate_thread_url(thread_url)
  ...
  def parse_body(body, skip_aa, skip_nl)
    # Shift-JIS -> UTF-8
